def check(pieces, firsttap, from_x, from_y, to_x, to_y):
    ...
    if firsttap == "bk" or firsttap == "wk":
        ...
        elif firsttap == "wk" or firsttap == "bk" and to_x == 7 and to_y == 6 or to_x == 0 and to_y == 6:
                if pieces[from_x][from_y + 1] == "-" and pieces[from_x][from_y + 2] == "-":
                    rr = pieces[from_x][from_y + 3]
                    if rr[1] == "r":
                        pieces[from_x][from_y + 3] = "-"
                        pieces[from_x][from_y + 1] = "wr"
                        return True
        elif firsttap == "wk" or firsttap == "bk" and to_x == 7 and to_y == 1 or to_x == 0 and to_y == 1:
                if pieces[from_x][from_y - 1] == "-" and pieces[from_x][from_y - 2] == "-" and pieces[from_x][from_y - 3] == "-":
                    bb= pieces[from_x][from_y + 3]
                    if bb[1] == "r":
                        pieces[from_x][from_y - 4] = "-"
                        pieces[from_x][from_y - 2] = bb
                        return True
        else:
            return False
